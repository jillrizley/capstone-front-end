...
var config = {
  apiOrigins: {
    ...
    production: 'https://rocky-scrubland-71771.herokuapp.com'
  }
};
...
var addAlbum = function addAlbum(e) {
  e.preventDefault();
  var data = getFormFields(e.target);
  api.add(data).then(ui.onAddSuccess).catch(ui.onAddError);
};

var showAlbums = function showAlbums() {
  api.index().then(ui.onShowSuccess);
};

var updateAlbum = function updateAlbum(e) {
  e.preventDefault();
  var data = getFormFields(e.target);
  api.update(data, data.album.id).then(function (rtn) {
    ui.onUpdateSuccess(data.album.id);
  });
};

var deleteAlbum = function deleteAlbum() {
  var id = $(this).closest('div').data('album-id');
  api.destroy(id).then(ui.onDestroySuccess.bind(this));
};
...
var albumEvents = __webpack_require__(9);
var photoEvents = __webpack_require__(38);
...
var onSignUp = function onSignUp(event) {
  ...
  }).then(ui.signInSuccess).catch(ui.signUpError);
};
...
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.signIn(data).then(ui.signInSuccess).catch(ui.signInError);
};
...
var onChangePassword = function onChangePassword(event) {
  var data = getFormFields(event.target);
  event.preventDefault();
  api.changePassword(data).done(ui.changePasswordSuccess).catch(ui.changePasswordError);
};
...
var onSignOut = function onSignOut(event) {
  event.preventDefault();
  api.signOut().done(ui.signOutSuccess).catch(ui.failure);
};
...
var signInError = function signInError(response) {
...
var signOutError = function signOutError(response) {};

var changePasswordSuccess = function changePasswordSuccess(response) {
  $('#-changepwd-modal').modal('hide');
};

var changePasswordError = function changePasswordError(response) {
...
var albumTemplate = __webpack_require__(21);
// const albumsTemplate = require('../templates/albums.hbs')

var onAddSuccess = function onAddSuccess(data) {
...
var onAddError = function onAddError(error) {
  console.log(error);
  $('#createAlbumModal').modal('hide');
  $('#content').empty();
};

var onShowSuccess = function onShowSuccess(data) {
  $('#content').html('');
...
var onUpdateSuccess = function onUpdateSuccess(albumId) {
  $('#editAlbumModal').modal('hide');
  var title = $('#editAlbumModal input[type=text]').val();
  $('#editAlbumModal input[type=text]').val('');
  var description = $('#editAlbumModal textarea').val();
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"col grid\" data-album-id=\""
    ...
    + "</p>\n  <button type=\"button\" class=\"btn btn-default btn-sm viewAlbumBtn\">View Album</button>\n  <button type=\"button\" class=\"btn btn-default btn-sm editAlbumBtn\">Edit Album</button>\n  <button type=\"button\" class=\"btn btn-default btn-sm addPhotoInputBtn\">Add Link</button>\n  <button type=\"button\" class=\"btn btn-danger btn-sm deleteAlbumBtn\">Delete Album</button>\n  <div class=\"newPhotoInput well-sm\"></div>\n  <div class=\"photoUrls well-sm\"></div>\n</div>\n";
},"useData":true});
...
var getPhotosByAlbum = function getPhotosByAlbum() {
  var albumId = $(this).closest('[data-album-id]').data('album-id');
  api.index({ albumId: albumId }).then(ui.onGetSuccess.bind(this)).catch(ui.onAddError);
};

var addPhoto = function addPhoto(e) {
  e.preventDefault();
  var data = getFormFields(e.target);
  var $album = $(this).closest('[data-album-id]');
  data.photo.albumId = $album.data('album-id');
  api.add(data).then(ui.onAddSuccess.bind(this)).then(function () {
    $album.find('.viewAlbumBtn').trigger('click');
  }).catch(ui.onAddError);
};

var deletePhoto = function deletePhoto() {
  var id = $(this).closest('li').data('photo-id');
  api.destroy(id).then(ui.onDestroySuccess.bind(this));
};
...
var photoInputTemplate = __webpack_require__(41);
var photoTemplate = __webpack_require__(42);

var onGetSuccess = function onGetSuccess(data) {
  var container = $(this).closest('[data-album-id]').find('.photoUrls');
  container.html('');
...
var addPhotoInput = function addPhotoInput() {
  var $photoInput = $(this).siblings('.newPhotoInput').html(photoInputTemplate);
  var offset = $photoInput.offset();
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<form class=\"addPhotoForm\">\n  <div class=\"form-group\">\n    <label>Link Title</label>\n    <input type=\"text\"  class=\"form-control\" name=\"photo[title]\" placeholder=\"title\" value=\""
    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
    + "\"/>\n  </div>\n  <div class=\"form-group\">\n    <label>URL</label>\n    <input type=\"text\"  class=\"form-control\" name=\"photo[url]\" placeholder=\"URL\" value=\""
    + alias4(((helper = (helper = helpers.url || (depth0 != null ? depth0.url : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"url","hash":{},"data":data}) : helper)))
    + "\"/>\n  </div>\n  <input type=\"submit\" class=\"btn addPhotoBtn btn-sm\" value=\"Add Link\" />\n</form>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<li data-photo-id=\""
    ...
    + "\" target=\"_blank\">"
    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
    + "</a>\n  <span><button type=\"button\" class=\"btn-xs btn-danger deletePhotoBtn\">X</button></span>\n</li>\n";
},"useData":true});
...
module.exports = __webpack_require__.p + "7ad3c85061087a026d6da46a6156ab09.jpg";
